...
public class BrevoEmailService {
    ...
    public void sendPasswordResetCode(String toEmail, String fullName, String code) {
        ...
        String htmlContent = """
                ...
                """.formatted(emailBannerHtml(), escapeHtml(name), code, resetUrl);
    ...
    public void sendEmailVerificationCode(String toEmail, String fullName, String code) {
        ...
        String htmlContent = """
                ...
                """.formatted(emailBannerHtml(), escapeHtml(name), code);
    ...
    public void sendAdminPasswordChangeCode(String toEmail, String code) {
        ...
        String subject = "Código para cambiar contraseña - JONZKO Admin";
        ...
        String htmlContent = """
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 24px; border: 1px solid #eeeeee; border-radius: 12px;">
                    ...
                    <p>Recibimos una solicitud para cambiar la contraseña del panel administrativo.</p>
                    ...
                    <p style="color: #777777; font-size: 13px;">
                        Si tú no solicitaste cambiar la contraseña, ignora este correo y revisa tu seguridad.
                    </p>
                </div>
                """.formatted(emailBannerHtml(), escapeHtml(name), code);
        ...
        try {
            ...
            throw new RuntimeException("No se pudo enviar el código para cambiar contraseña admin", e);
        }
    }

    private String emailBannerHtml() {
        return """
                <div style="text-align:center; margin-bottom:22px;">
                    <img
                        src="https://www.jonzko.lat/assets/jonzko-sport.jpeg"
                        alt="JONZKO SPORT"
